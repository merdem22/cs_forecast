...
# Minimal set of datasets for detection + forecasting experiments
DATASETS = {
    # Detection datasets (full 8 s, non-overlapping windows)
    ...
    # Forecasting datasets (early slices only)
    "fc_2s_first4": dict(window_seconds=2.0, stride_seconds=2.0, max_windows_per_trial=2, out="data/npz/cdms_fc_2s_first4.npz"),   # first two 2s windows
    "fc_3s_stride2x2": dict(window_seconds=3.0, stride_seconds=2.0, max_windows_per_trial=2, out="data/npz/cdms_fc_3s_stride2x2.npz"), # first two 3s windows, stride 2
    "fc_3s_stride1x3": dict(window_seconds=3.0, stride_seconds=1.0, max_windows_per_trial=3, out="data/npz/cdms_fc_3s_stride1x3.npz"), # first three 3s windows, stride 1
}
